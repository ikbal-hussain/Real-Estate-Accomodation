...
export const registerUser = createAsyncThunk('auth/registerUser', async ({ email, age, location, name, role, password }, { rejectWithValue }) => {
  try {
    ...
    return { id: response.data.name, email, age, location }; // Include the id in the returned data
  } catch (error) {
    console.log(error)
